...
import library.swipetoloadlayout.SwipeLoadMoreFooterLayout;
...
public class ClassicLoadMoreFooterView extends SwipeLoadMoreFooterLayout {
    ...
    public ClassicLoadMoreFooterView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFooterHeight = 60;//getResources().getDimensionPixelOffset(R.dimen.load_more_footer_height_classic);
    }
