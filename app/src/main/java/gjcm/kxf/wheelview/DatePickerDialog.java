...
public class DatePickerDialog extends BaseDialog implements
    ...
    private TextView txtNow, txtThre, txtFive;
    ...
    LinearLayout.LayoutParams endlayou;
    ...
    private void init() {
        ...
        endlayou = new LinearLayout.LayoutParams(
                LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT, 1.0f);
...
//        EndPicker.addView(endOther);
        ...
        txtFive = (TextView) findViewById(R.id.dialog_fivet);
        txtThre = (TextView) findViewById(R.id.dialog_thren);
        txtNow = (TextView) findViewById(R.id.dialog_now);
        txtThre.setOnClickListener(this);
...
//                setYear(currentYear);
    ...
    private String[] todate() {
        ...
        String str = dateFormat.format(curren);
        strings[0] = str;
        curren += 15 * 60 * 1000;
        dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        str = dateFormat.format(curren);
        strings[1] = str;
        return strings;
    }
    ...
    public void onClick(View v) {
        ...
        if (v == btnSure) {
            ...
            int nowday = getDay();
            onDatePickListener.onClick(nowyear + "", nowmonth + "", nowday + "", nowyear + "", nowmonth + "", nowday + "", "00", "23");

        } else if (v == txtThre) {
            dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            endtime = dateFormat.format(da);
            curren -= 3 * 24 * 60 * 60 * 1000;
            da = new Date(curren);

            betime = dateFormat.format(da);
            onDatePickListener.date(betime, endtime);

        } else if (v == txtFive) {
            dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            endtime = dateFormat.format(da);
            curren -= 5 * 24 * 60 * 60 * 1000;
            da = new Date(curren);
    ...
    public interface OnDatePickListener {
        ...
        void date(String begin, String end);
